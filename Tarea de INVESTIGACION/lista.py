...
class Lista(Intermedio):
    ...
    def insertarLista(self,posicion,valor):
        list1= self.lista.insert(posicion,valor)
        return "La nueva lista es: {}".format(list1)
    ...
    def retornaValorLista(self,posicion):
        if posicion<len(self.lista):
            list1= self.lista.pop(posicion)
            print("El valor eliminado es: {}".format(list1.split()))
        else:
